...
export const CATEGORIES_LOAD_REQUEST = 'CATEGORIES_REQUEST';
export const CATEGORIES_LOAD_SUCCESS = 'CATEGORIES_SUCCESS';
export const CATEGORIES_LOAD_FAILURE = 'CATEGORIES_FAILURE';
